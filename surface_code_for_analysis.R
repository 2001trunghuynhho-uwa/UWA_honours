...
# ------------------------------
# Function 1: compute mean slope for one run
# ------------------------------
...
# ------------------------------
ts_all <- bind_rows(
  get_slope_ts("./DEMs/GRA-1-LO/", "GRA-1-LO"),
  get_slope_ts("./DEMs/GRA-2-LO/", "GRA-2-LO"),
  get_slope_ts("./DEMs/GRA-3-LO/", "GRA-3-LO"),
  get_slope_ts("./DEMs/GRA-4-LO/", "GRA-4-LO"),
  get_slope_ts("./DEMs/GRA-5-LO/", "GRA-5-LO"),
  get_slope_ts("./DEMs/GRA-6-LO/", "GRA-6-LO"),
  get_slope_ts("./DEMs/GRA-7-LO/", "GRA-7-LO"),
  get_slope_ts("./DEMs/GRA-8-LO/", "GRA-8-LO")
)
...
ts_table <- ts_all |> 
  mutate(
    Sample = run,
    Grinding_duration = time_min, 
    surface_index = slope_mean
  ) |>  
  select(Sample, Grinding_duration, surface_index) |> 
  filter(Sample == "GRA-1-LO")

#f <- flextable(ts_table)
#f <- f |> 
#  theme_booktabs() |> 
#  autofit() |>  
...
plot_slope_0_120("./DEMs/GRA-1-LO/", "GRA-1-LO")
plot_slope_0_120("./DEMs/GRA-2-LO/", "GRA-2-LO")
plot_slope_0_120("./DEMs/GRA-3-LO/", "GRA-3-LO")
plot_slope_0_120("./DEMs/GRA-4-LO/", "GRA-4-LO")
plot_slope_0_120("./DEMs/GRA-5-LO/", "GRA-5-LO")
plot_slope_0_120("./DEMs/GRA-6-LO/", "GRA-6-LO")
plot_slope_0_120("./DEMs/GRA-7-LO/", "GRA-7-LO")
plot_slope_0_120("./DEMs/GRA-8-LO/", "GRA-8-LO")
